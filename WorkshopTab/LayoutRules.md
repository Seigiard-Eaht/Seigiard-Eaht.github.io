...
Надо максимально избегать стилей в тексте: prefWidth, prefHeight, minWidth, minHeight, <Insets> и прочая ерунда запрещены. maxWidth может быть использован пару раз.
